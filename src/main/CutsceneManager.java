...
import entity.NPC_BlackPanther;
...
//                if(gp.monster[gp.currentMap][i] != null && gp.monster[gp.currentMap][i].name != null && gp.monster[gp.currentMap][i].name.equals(MON_SkeletonLord.monName))
                if(gp.npc[this.gp.currentMap][i] != null && gp.npc[this.gp.currentMap][i].name != null && gp.npc[this.gp.currentMap][i].name.equals(PlayerDummy.npcName))
    ...
    public void scene_ending()
    {
        ...
        if(scenePhase == 5)
        {
           ...
           /* alpha += 0.005f;  // after 200 frames alpha becomes 1
            ...
            String text = "Following the fierce battle with the Skeleton Lord,\n"
                    + "Our hero finally saved all heroes.\n"
                    + "Yet, this is not the end of his journey.\n"
                    + "Innie's adventure had just begun.";
        ...
        if(scenePhase == 6)
        {
            ...
            drawString(alpha,120f, gp.screenHeight/2, "Code Name: Innie", 40);
