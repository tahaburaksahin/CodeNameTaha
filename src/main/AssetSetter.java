...
public class AssetSetter {
    ...
    public void setObject()
    {
        ...
        i++;
        gp.obj[mapNum][i] = new OBJ_Chest(gp);
        gp.obj[mapNum][i].setLoot(new OBJ_Potion_Green(gp));
    ...
    public void setNPC()
    {
        ...
        gp.npc[mapNum][i] = new NPC_WomanWizard(gp);
        gp.npc[mapNum][i].worldX = gp.tileSize*12;
        gp.npc[mapNum][i].worldY = gp.tileSize*7;

        i++;
        gp.npc[mapNum][i] = new NPC_Cop(gp);
    ...
    public void setInteractiveTile()
    {
        ...
        mapNum=3;
        i=0;
        // gp.iTile[mapNum][i] = new IT_MetalPlate(gp,5,6);i++;

        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,24,12);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,26,12);i++;

        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,16,12);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,15,12);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,14,12);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,14,13);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,13,13);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,12,13);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,12,13);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,12,12);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,12,11);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,12,10);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,11,10);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,10,10);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,9,10);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,9,9);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,9,8);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,9,7);i++;
        gp.iTile[mapNum][i] = new IT_DestructibleWall(gp,8,7);i++;
