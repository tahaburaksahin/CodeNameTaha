...
public class MON_SkeletonLord extends Entity {
    ...
    {
        dialogues[0][0] = "\nNo one can save these hereos.WELCOME TO YOUR DOOM!";
        dialogues[0][1] = "You will die here.\nWait a minute! You are a cat\n Little Kitty AHAHAHAHA";
        dialogues[0][2] = "Are you lost in the forest\n Do u need help ahahaha ";
        dialogues[0][2]="If you expect mercy from me, you are mistaken.\nCome and taste the bitterness of death.";
